function! s:gruvbox_material_settings()
  ...
  let g:gruvbox_material_visual = 'reverse'  " (grey background), red background, green background, blue background, reverse
...
function! s:gruvbox_material_colors()
  ...
  " call gruvbox_material#highlight('Visual', l:palette.none, l:palette.bg2)
  " call gruvbox_material#highlight('VisualNOS', l:palette.none, l:palette.bg2)
  ...
  call gruvbox_material#highlight('CursorLineNR', l:palette.grey2, l:palette.none)
  ...
  call gruvbox_material#highlight('Comment', l:palette.bg3, l:palette.none, 'italic')
  call gruvbox_material#highlight('Todo', l:palette.grey2, l:palette.none, 'bolditalic')

  call gruvbox_material#highlight('String', l:palette.fg1, l:palette.bg2, 'bold')
  " call gruvbox_material#highlight('Identifier', l:palette.grey2, l:palette.none)

  " call gruvbox_material#highlight('Function', l:palette.yellow, l:palette.none, 'bold')

  " call gruvbox_material#highlight('Delimiter', l:palette.grey2, l:palette.none)
  ...
  call gruvbox_material#highlight('NonText', l:palette.bg3, l:palette.none)
  " call gruvbox_material#highlight('SpecialKey', l:palette.bg2, l:palette.none)

  " call gruvbox_material#highlight('LeadingSpace', l:palette.none, l:palette.bg_visual_red)
  " match LeadingSpace /^\s\+/

  " call gruvbox_material#highlight('TrailingSpace', l:palette.none, l:palette.bg_visual_red)
  " match TrailingSpace / \+$/

  " highlight ExtraWhitespace ctermbg=red guibg=red
  call gruvbox_material#highlight('ExtraWhitespace', l:palette.none, l:palette.bg2)
  " call gruvbox_material#highlight('ExtraWhitespace', l:palette.none, l:palette.bg_dim)
