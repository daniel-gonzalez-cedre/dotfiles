#let toc(body) = {
  show heading.where(level: 1): it => {
    set text(size: 22.0pt, style: "italic", weight: "bold")
    block(
      v(32.0pt + 48.0pt)
      + it.body
    )
  ...
  show outline.entry.where(level: 1): set text(size: 16.0pt, style: "italic")
  show outline.entry.where(level: 2): set text(size: 11.0pt, style: "italic")
  show outline.entry.where(level: 3): set text(size: 11.0pt, style: "italic")
